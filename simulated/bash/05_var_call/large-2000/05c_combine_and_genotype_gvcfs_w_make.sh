...
#SBATCH --job-name=large-2000_05c_combine_and_genotype_gvcfs
...
for c in ${cvgX[@]}; do 
	...
	MAP_FILE=${OUTPUT_DIR}/large-2000_sample_cvg_${c}_map.list
	ls large-2000_sample_cvg_${c}/*.g.vcf > ${MAP_FILE}
	

	OUT_FILE=large-2000_sample_cvg_${c}_combined_gvcfs.vcf
	...
	OUT_FILE=large-2000_sample_cvg_${c}_genotyped_gvcfs.vcf
