...
#SBATCH --job-name=decline_06b_run_PLINK
#SBATCH -N 1
#SBATCH -n 20
#SBATCH -t 12:00:00
#SBATCH --mem=32000
...
for c in ${cvgX[@]}; do
	...
	OUT_FILE=decline_sample_cvg_${c}_plink
						...
						for p6 in ${phwt[@]}; do         # -homozyg-window threshold
							for p7 in ${phzs[@]}; do     # -homozyg-snp
								for p8 in ${phzk[@]}; do # -homozyg-kb
									...
									IN_FILE=decline_sample_cvg_${c}_plink
									OUT_FILE=decline_sample_cvg_${c}_plink_roh${PARAM_SUFFIX}
