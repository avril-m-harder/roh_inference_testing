...
#SBATCH --job-name=bottle_06b_run_PLINK
#SBATCH -N 1
#SBATCH -n 20
#SBATCH -t 12:00:00
#SBATCH --mem=32000
...
for c in ${cvgX[@]}; do
	...
	OUT_FILE=bottle_sample_cvg_${c}_plink
	...
	declare -a phwh=(1 2 3)         # Values for -homozyg-window-het
	declare -a phwm=(5)             # Values for -homozyg-window-missing
	declare -a phws=(50 75 100)     # Values for -homozyg-window-snp
	...
	declare -a phzs=(50 100 150)    # Values for -homozyg-snp
						...
						for p6 in ${phwt[@]}; do         # -homozyg-window threshold
							for p7 in ${phzs[@]}; do     # -homozyg-snp
								for p8 in ${phzk[@]}; do # -homozyg-kb
									...
									PARAM_SUFFIX=_phwh_${p1}_phwm_${p2}_phws_${p3}_phzd_${p4}_phzg_${p5}_phwt_${p6}_phzs_${p7}_phzk_${p8}_ROUND2
									IN_FILE=bottle_sample_cvg_${c}_plink
									OUT_FILE=bottle_sample_cvg_${c}_plink_roh${PARAM_SUFFIX}
