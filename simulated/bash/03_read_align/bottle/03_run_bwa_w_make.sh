...
#SBATCH --job-name=bottle_03_read_align
...
# 
# 	OUT_FILE=bottle_${line[0]}_genome.bam
# 	start_logging "bwa align - ${OUT_FILE}"
# 
# 	bwa mem -t 20 -M \
# 		${REF_GENOME_FILE} \
# 		${INPUT_DIR}/bottle/bottle_${line[0]}_f.fq \
# 		${INPUT_DIR}/bottle/bottle_${line[0]}_r.fq \
# 		> ${OUT_FILE}
# 
# 	stop_logging
# 
...
# while read -a line; do
# 
# 	OUT_FILE=bottle_${line[0]}_genome_sorted.bam
# 	start_logging "samtools sort - ${OUT_FILE}"
# 
# 	samtools sort -@ 19 \
# 		-o ${OUT_FILE} \
# 		bottle_${line[0]}_genome.bam
# 
# 	stop_logging
# 
# done < ${SAMPLE_ID_LIST}
...
cp ./bottle/bottle_*_genome_sorted.bam \
