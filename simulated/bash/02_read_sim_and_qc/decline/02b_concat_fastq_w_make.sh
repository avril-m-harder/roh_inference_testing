#!/bin/bash
#
#SBATCH --job-name=decline_02b_concat_fastq
...
# for d in ${dems[@]}; do
	...
	while read -a line; do
		...
		cat decline_${line[0]}_11.fq decline_${line[0]}_21.fq > decline_${line[0]}_f.fq
		cat decline_${line[0]}_12.fq decline_${line[0]}_22.fq > decline_${line[0]}_r.fq
