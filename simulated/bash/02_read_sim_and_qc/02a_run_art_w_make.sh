...
#SBATCH --job-name=_demo__02a_read_sim_and_qc
...
# for d in ${dems[@]}; do
	...
	VCF_OUT_DIR=${INIT_OUTPUT_DIR}/sample_vcf_files__demo_
	FASTA_OUT_DIR=${INIT_OUTPUT_DIR}/sample_fasta_files__demo_
	SAMPLE_ID_LIST=${INIT_OUTPUT_DIR}/sample_ID_list__demo_.txt

	while read -a line; do

		if [ ! -f ${OUTPUT_DIR}/_demo__${line[0]}_11.fq ]
		then
			...
			for a in 1 2; do
				...
				art_illumina \
					--seqSys HS25 \
					-i ${FASTA_OUT_DIR}/_demo__${line[0]}_$a.fasta \
					--paired \
					-na \
					--len 150 \
					--fcov 25 \
					-m 500 \
					-s 75 \
					-o ${OUTPUT_DIR}/_demo__${line[0]}_$a
