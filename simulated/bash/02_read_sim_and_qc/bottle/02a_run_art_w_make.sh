...
#SBATCH --job-name=bottle_02a_read_sim_and_qc
...
# for d in ${dems[@]}; do
	...
	VCF_OUT_DIR=${INIT_OUTPUT_DIR}/sample_vcf_files_bottle
	FASTA_OUT_DIR=${INIT_OUTPUT_DIR}/sample_fasta_files_bottle
	SAMPLE_ID_LIST=${INIT_OUTPUT_DIR}/sample_ID_list_bottle.txt

	while read -a line; do

		if [ ! -f ${OUTPUT_DIR}/bottle_${line[0]}_11.fq ]
		then
			...
			for a in 1 2; do
				...
				art_illumina \
					--seqSys HS25 \
					-i ${FASTA_OUT_DIR}/bottle_${line[0]}_$a.fasta \
					--paired \
					-na \
					--len 150 \
					--fcov 25 \
					-m 500 \
					-s 75 \
					-o ${OUTPUT_DIR}/bottle_${line[0]}_$a
