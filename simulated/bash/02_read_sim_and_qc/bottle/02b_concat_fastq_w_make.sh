#!/bin/bash
#
#SBATCH --job-name=bottle_02b_concat_fastq
...
# for d in ${dems[@]}; do
	...
	while read -a line; do
		...
		cat bottle_${line[0]}_11.fq bottle_${line[0]}_21.fq > bottle_${line[0]}_f.fq
		cat bottle_${line[0]}_12.fq bottle_${line[0]}_22.fq > bottle_${line[0]}_r.fq
