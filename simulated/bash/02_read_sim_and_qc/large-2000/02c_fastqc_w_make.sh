#!/bin/bash
#SBATCH --job-name=large-2000_02c_read_sim_and_qc
...
# for d in ${dems[@]}; do
	...
	cd ${OUTPUT_DIR}
	cd ..
	FASTQC_OUT_DIR=fastqc_reports_large-2000
	...
	while read -a line; do
		...
		fastqc -t 5 -o ./${FASTQC_OUT_DIR} \
			${OUTPUT_DIR}/large-2000_${line[0]}_f.fq \
			${OUTPUT_DIR}/large-2000_${line[0]}_r.fq
