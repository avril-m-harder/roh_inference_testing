...
#  }}
make_slim <- function(genome_size = NULL, pop_size1 = NULL, pop_size2 = NULL, pop_size3 = NULL, pop_size4 = NULL, 
...
muts[mut_index].id, muts[mut_index].position, muts[mut_index].selectionCoeff, muts[mut_index].originTick));
...
paste(c(header1, out1), sep="\\n"));
      ...
      write_lines(slim_file, glue("{slim_code_out}/tasdev_{demo_mod}_{seed}.slim"))
