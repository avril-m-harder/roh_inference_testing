...
I=/scratch/avrilh/rohparam_02_read_mapping/sorted_bams/_samp__rgroups.bam \
O=_samp__rgroups_dupmarked.bam \
M=_samp__rgroups_markdup_metrics.txt \
MAX_RECORDS_IN_RAM=250000

## Fix mate information
java -jar /tools/picard-2.23.9/libs/picard.jar FixMateInformation \
I=_samp__rgroups_dupmarked.bam \
O=_samp__rgroups_dupmarked_fixmate.bam
...
samtools index -c -@ 3 _samp__rgroups_dupmarked_fixmate.bam
